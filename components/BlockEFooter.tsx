...
const socialLinks = [
  { icon: Twitter, href: 'https://twitter.com/BlockE' },
  { icon: Github, href: 'https://github.com/BlockE' },
  { icon: Discord, href: 'https://discord.gg/BlockE' },
]
    ...
    <footer className="bg-black text-white py-16">
      <div className="container mx-auto px-8">
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>© 2024 BlockE. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
