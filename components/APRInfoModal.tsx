    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white/95 backdrop-blur-md rounded-xl p-6 max-w-md w-full mx-4 relative border border-[#4F46E5] shadow-xl">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-700">
            This rate is annualized, meaning it's projected over a year, even for shorter staking periods.
          </p>
          <p className="text-gray-700">
            Remember, APR doesn't account for compounding. Actual returns may vary based on market conditions and token price fluctuations.
          </p>
        </div>
      </div>
    </div>
