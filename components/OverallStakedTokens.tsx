...
interface OverallStakedTokensProps {
  amount: string
}

export default function OverallStakedTokens({ amount }: OverallStakedTokensProps) {
  return (
    <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl p-4 border-2 border-[#4F46E5] shadow-lg">
      <div className="flex items-center gap-2">
        ...
        />
        <span className="text-lg font-semibold">Overall Staked BE:</span>
      </div>
