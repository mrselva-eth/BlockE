...
export default function ChatInterface() {
  ...
  const { balance, deductToken } = useAIBalance()
            ...
            <div className="flex flex-col">
              <div
                className={`rounded-lg p-3 max-w-[80%] ${
                  message.role === 'assistant'
                    ? 'bg-white border border-[#4F46E5] text-black'
      ...
      <form onSubmit={handleSubmit} className="p-4 bg-white/50 backdrop-blur-sm">
        <div className="flex gap-2">
          ...
          <input
            ...
            className="flex-1 rounded-lg border border-[#4F46E5] px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#4F46E5] text-black bg-white/90 placeholder:text-gray-500"
            disabled={isLoading}
          />
          <button
            type="submit"
