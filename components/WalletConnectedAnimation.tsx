        ...
        >
          ...
          >
            <div className="flex flex-col items-center">
              ...
              >
                Welcome to the BlockE ecosystem
              </motion.p>
              ...
              <motion.div
                ...
                className="mt-4 px-4 py-2 rounded-lg bg-gradient-to-r from-purple-100 to-pink-100 text-sm text-gray-600"
              >
